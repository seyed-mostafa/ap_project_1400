...
public class Database {
        ...
        static {
                ...
                Restaurant[] restaurant = { new Restaurant("Reihoon", new Location(
                                "golbarg,kh kerman,pelak 34,vahed 2,salam bar hame daram talash mikonam ke matn ziadi benevisam :)",
                                233.21, 3243.24), "09123456780", "123")

                                ,
                                new Restaurant("Mashti", new Location(
                                                "golbarg,kh kerman,pelak 34,vahed 2,salam bar hame daram talash mikonam ke matn ziadi benevisam :)",
                                                5, 50.331243399093914), "09123456781", "123")

                                ,
                                new Restaurant("akbar jooje", new Location(
                                                "golbarg,kh kerman,pelak 34,vahed 2,salam bar hame daram talash mikonam ke matn ziadi benevisam :)",
                                                34.717676891099835, 50.331243399093914), "09123456783", "123")

                                ,
                                new Restaurant("asghar jooje", new Location(
                                                "golbarg,kh kerman,pelak 34,vahed 2,salam bar hame daram talash mikonam ke matn ziadi benevisam :)",
                                                34.717676891099835, 50.331243399093914), "09123456784", "123")

                                ,
                                new Restaurant("javanan", new Location(
                                                "golbarg,kh kerman,pelak 34,vahed 2,salam bar hame daram talash mikonam ke matn ziadi benevisam :)",
                                                34.717676891099835, 50.331243399093914), "09123456785", "123")

                                ,
                                new Restaurant("mostafa va abbas", new Location(
                                                "golbarg,kh kerman,pelak 34,vahed 2,salam bar hame daram talash mikonam ke matn ziadi benevisam :)",
                                                34.717676891099835, 50.331243399093914), "09123456786", "123")

                                ,
                                new Restaurant("Daneshjoo", new Location(
                                                "golbarg,kh kerman,pelak 34,vahed 2,salam bar hame daram talash mikonam ke matn ziadi benevisam :)",
                                                34.717676891099835, 50.331243399093914), "09123456787", "123")

                                ,
                                new Restaurant("bikaran", new Location(
                                                "golbarg,kh kerman,pelak 34,vahed 2,salam bar hame daram talash mikonam ke matn ziadi benevisam :)",
                                                34.717676891099835, 50.331243399093914), "09123456788", "123")

                                ,
                                new Restaurant("Bahar", new Location(
                                                "golbarg,kh kerman,pelak 34,vahed 2,salam bar hame daram talash mikonam ke matn ziadi benevisam :)",
                                                34.717676891099835, 50.331243399093914), "09123456789", "123")

                                ,
                                new Restaurant("topolooo", new Location(
                                                "golbarg,kh kerman,pelak 34,vahed 2,salam bar hame daram talash mikonam ke matn ziadi benevisam :)",
                ...
                order1.setCustomerAddress(new Location(
                                "golbarg,kh kerman,pelak 34,vahed 2,salam bar hame daram talash mikonam ke matn ziadi benevisam :)",
                                34.717676891099835, 51.331243399093914));
                order2.setCustomerAddress(new Location(
                                "golbarg,kh kerman,pelak 34,vahed 2,salam bar hame daram talash mikonam ke matn ziadi benevisam :)",
                                35.717676891099835, 25.331243399093914));
                ...
                for (Order order : customer1.getShoppingCart()) {
                        order.setRestaurantName(restaurants.get(0).getName());
                        order.setRestaurantAddress(new Location(
                                        "golbarg,kh kerman,pelak 34,vahed 2,salam bar hame daram talash mikonam ke matn ziadi benevisam :)",
                                        34.7176769835, 51.39093914));
                }
                // customer1.getShoppingCart().indexOf(0).setRestaurantName(restaurant[0].getName());
                // customer1.getShoppingCart()[0].setRestaurantAddressString(" Tehran Province,
                // Tehran, District 7, Mir Emad St &, Shahid Motahari St");

                // customer1.addShoppingCart(restaurant[1].getMenu()[2], restaurant[1].getId(),
                // 1);
                // customer1.addShoppingCart(restaurant[1].getMenu()[3], restaurant[1].getId(),
                // 2);
                // customer1.addShoppingCart(restaurant[1].getMenu()[4], restaurant[1].getId(),
                // 3);
                // customer1.getShoppingCart()[1].setRestaurantName(restaurant[1].getName());
                // customer1.getShoppingCart()[1].setRestaurantAddressString( "Tehran Province,
                // Tehran, District 7, Mir Emad St &, Shahid Motahari St");
                //
                //
                // Order order1 = new Order(restaurant[2].getMenu()[2], restaurant[2].getId(),
                // 1);
                ...
                // customer1.getPreviousOrders()[0].setRestaurantAddressString( "Tehran
                // Province, Tehran, District 7, Mir Emad St &, Shahid Motahari St");
                //
                // Order order2 = new Order(restaurant[3].getMenu()[2], restaurant[3].getId(),
                // 4);
                ...
                // customer1.getPreviousOrders()[1].setRestaurantAddressString( "Tehran
                // Province, Tehran, District 7, Mir Emad St &, Shahid Motahari St");
